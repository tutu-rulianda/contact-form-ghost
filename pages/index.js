          ...
          <form ref={formRef} className="space-y-8">
            ...
            <div className="flex gap-x-4">
              <div className="">
                ...
                <select
                  ...
                  onBlur={formik.handleBlur}
                  onChange={formik.handleChange}
                  className={`shadow-sm bg-gray-50 border text-gray-500 text-sm rounded-lg grow w-full p-2.5 dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white dark:shadow-sm-light relative
                  ${
            ...
            <div className="flex gap-x-4 flex-col sm:flex-row">
              <div className="grow">
                ...
                <input
                  className="block w-full text-sm text-gray-500 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
